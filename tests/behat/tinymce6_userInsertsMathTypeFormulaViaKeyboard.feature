@tinymce6 @tinymce6_wiris @wiris_mathtype @tinymce6_insert_formula @tinymce6_focus @mtmoodle-75
Feature: Insert MathType formula with tinymce6 editor only with the keyboard
...
I need to create a MathType formula
  ...
  Scenario: MTMOODLE-75 - User inserts MathType with tinymce6 via keyboard
