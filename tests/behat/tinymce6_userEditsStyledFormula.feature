@tinymce6 @tinymce6_wiris @wiris_mathtype @tinymce6_edit_formula @tinymce6_formula_type @mtmoodle-58
Feature: Edit MathType styled formula with tinymce6 editor
...
I need to create a styled MathType formula
  ...
  Scenario: MTMOODLE-58 - User edits MathType styled with tinymce6
    # Course
