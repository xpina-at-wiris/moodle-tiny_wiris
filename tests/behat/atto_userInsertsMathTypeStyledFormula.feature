@tinymce6 @tinymce6_wiris @wiris_mathtype @tinymce6_insert_formula @mtmoodle-57
Feature: Insert MathType styled formula with tinymce6 editor
...
I need to create a styled MathType formula
  ...
  Scenario: MTMOODLE-57 - User inserts MathType styled with tinymce6
